...
from app.adapter.input.graphql.resolvers.type.bus_stop import BusStop
from app.adapter.input.graphql.validators.bus_stop import (
    GetBusStopValidator,
    SearchBusStopsValidator,
)
from app.adapter.input.graphql.exception_handler import handle_exceptions
...
class BusStopQuery:
    ...
    def bus_stop(self, info: Info, id: int) -> BusStop:
        ...
        response: GetBusStopResponseDTO = bus_stop_use_case.get_bus_stop(request_dto)
